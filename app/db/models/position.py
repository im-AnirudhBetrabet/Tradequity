...
class MasterPosition(Base):
    ...
    allocated_quantity  : Mapped[Decimal]         = mapped_column(Numeric(20, 8), nullable=False)
    ...
    status              : Mapped[PositionStatus]  = mapped_column(SqlEnum(PositionStatus, name="position_status", native_enum=True, values_callable=lambda enum_cls: [e.value for e in enum_cls]), nullable=False)
